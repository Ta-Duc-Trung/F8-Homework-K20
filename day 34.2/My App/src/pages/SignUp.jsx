...
export default function SignUp() {
  ...
  return (
    <>
      <h1 className="text-xl font-bold mb-1">Đăng ký</h1>
      <p className="text-sm text-gray-500 mb-6">Tạo tài khoản mới</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {success && <p className="text-sm text-green-600">Đăng ký thành công (giả lập)!</p>}
      ...
      <p className="text-sm text-gray-500 mt-6 text-center">
        Đã có tài khoản?{" "}
        <Link to="/sign-in" className="text-orange-600 hover:underline">
          Đăng nhập
        </Link>
      </p>
    </>
